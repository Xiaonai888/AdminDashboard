...
const styles = `
  ...
  * { box-sizing: border-box; }
  ...
  .shadow-admin-sidebar::-webkit-scrollbar {
    width: 0;
  }
  ...
  .shadow-admin-sidebar:hover .shadow-admin-logo-text {
    opacity: 1;
  }
  ...
  .shadow-admin-sidebar:hover .shadow-admin-group-label {
    opacity: 1;
  }
  ...
  .shadow-admin-sidebar:hover .shadow-admin-nav-text {
    opacity: 1;
  }
        ...
        <div className="shadow-admin-main">
          <header className="shadow-admin-topbar">
            ...
            <div className="shadow-admin-profile">
              ...
              <button type="button" className="shadow-admin-signout" onClick={handleSignOut}>
                Sign Out
              </button>
            </div>
          </header>
