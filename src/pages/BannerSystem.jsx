...
const styles = `
  ...
  * {
  ...
  .slot-card.selected {
    border-color:var(--primary);
    box-shadow:0 0 0 3px rgba(79,70,229,.14),0 14px 34px rgba(79,70,229,.16);
  }
              ...
              <section className="panel editor-panel">
                ...
                <div className="editor-body">
                  ...
                  <div className="toggle-row">
                    <div>
                      ...
                      <div className="toggle-help">
                        {isActive ? 'Visible on frontend' : 'Hidden from frontend, still kept in AdminDashboard'}
                      </div>
                    </div>
                  ...
                  <div className="btn-row">
                    ...
                    <button className="btn-danger" type="button" onClick={handleDeleteBanner} disabled={loading || !selectedBanner}>
                      Delete Banner
                    </button>
                  </div>

                  <div className="note-box">
                    Turning visibility off only hides this banner from the frontend. It does not delete the banner from AdminDashboard. Use Delete Banner only when you want to remove it.
                  </div>
                </div>
              </section>
            </div>
              ...
              <div className="records-list">
                {records.length === 0 ? (
                  ...
                  records.map((record) => {
                    ...
                    return (
                      <div className="record-item" key={record.id || `${record.created_at}-${record.action}`}>
                        <div>
